...
export class FindAndReplaceInputHtmlForm extends Component {
  static propTypes = {
      ...
      <div className="bulk-edit--find-replace">
        <form onSubmit={handleSubmit(this.onSubmit)}>
          ...
          <div className="bulk-edit--replace">
            { !submitting && <FroalaHtmlInput {...filterInputFieldProps(replace)} onChange={this.onChangeReplace} placeholder="Replace" maxHeight={97} /> }
