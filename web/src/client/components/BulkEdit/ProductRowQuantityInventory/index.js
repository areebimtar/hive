...
export class ProductRowQuantityInventory extends Component {
  static propTypes = {
  ...
  renderVariations(product) {
    const value = product.get('_formattedQuantityInventory', new ListImm());
    ...
    const offeringListClasses = classNames('offering-list', 'quantity-editor', { global: isGlobal, 'read-only': readOnly });
...
export default connect()(ProductRowQuantityInventory);
