...
import { List as ListImm, Map } from 'immutable';
...
export class ProductRowPriceInventory extends Component {
  static propTypes = {
    dispatch: PropTypes.func.isRequired,
    product: PropTypes.object.isRequired
  }

  onChange = (value) => this.props.dispatch(Actions.BulkEdit.appendInlineEditOpValue(value.set('value', new Map({value: value.get('value')}))))
  ...
  renderVariations(product) {
    ...
    const value = product.get('_formattedPriceInventory', new ListImm());
    ...
    const offeringListClasses = classNames('offering-list', 'price-editor', { global: isGlobal, 'read-only': readOnly });
...
export default connect()(ProductRowPriceInventory);
