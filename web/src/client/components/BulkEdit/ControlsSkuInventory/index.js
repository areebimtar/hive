...
import { SKU_INVENTORY_OPTIONS } from 'app/client/constants/bulkEdit';

class ControlsSkuInventory extends Component {
  static propTypes = {
    ...
    return (
      <div className="bulk-edit--actions">
        <div className="bulk-edit--actionselector">
          <DropdownList data={SKU_INVENTORY_OPTIONS}
...
export default connect()(ControlsSkuInventory);
