...
const OPTIONS = getAttributeWithNone('occasion').get('availableOptions', new List());

export class ControlsOcassion extends Component {
  static propTypes = {
    dispatch: PropTypes.func.isRequired,
    data: PropTypes.object
  };

  onChange = (occasion) => this.props.dispatch(Actions.BulkEdit.setOperationAndValue({
...
export default connect()(ControlsOcassion);
