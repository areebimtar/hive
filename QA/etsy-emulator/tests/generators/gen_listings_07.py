...
def print_json(listing_id, title, category, tag, material, recipient, occasion, style):
...
i = 1
while i < 100:
    print_json(100000 + i, 'First something 1234 (' + str(i) + ')',  categories[0], tags[0], materials[0], recipients[0], occasions[0], styles[0])
    i += 1
    print_json(100000 + i, 'Second something 1235 (' + str(i) + ')', categories[0], tags[0], materials[1], recipients[0], occasions[0], styles[0])
    i += 1
    print_json(100000 + i, 'Third something LG-512a (' + str(i) + ')',  categories[1], tags[0], materials[1], recipients[0], occasions[0], styles[0])
    i += 1
    print_json(100000 + i, 'Forth something 123456 (' + str(i) + ')',  categories[2], tags[1], materials[2], recipients[0], occasions[0], styles[0])
    i += 1
    print_json(100000 + i, 'Fifth something (' + str(i) + ')',  categories[3], tags[1], materials[3], recipients[0], occasions[0], styles[0])
    i += 1
    print_json(100000 + i, 'Sixth something (' + str(i) + ')',  categories[3], tags[2], materials[3], recipients[0], occasions[0], styles[0])
    i += 1
