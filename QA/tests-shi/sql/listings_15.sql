...
-- README
-- Test data generated by 'test_generate_listings_15_sql' from Etsy test case 'listings_15'
...
SELECT pg_catalog.setval('attributes_id_seq', 2, true);
...
SELECT pg_catalog.setval('image_id_seq', 2, true);
...
72	1516727958724_shops_created_at	2018-01-24 15:00:50.296365
\.
...
SELECT pg_catalog.setval('product_offering_id_seq', 2, true);
...
1	last_seen_shop	2	2018-01-03 17:18:21.316938+01
1	syncStatusModalSeen	true	2018-01-03 17:18:24.936905+01
\.
