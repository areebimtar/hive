...
-- README
-- Test data generated by 'test_generate_listings_10_sql' from Etsy test case 'listings_10'
...
SELECT pg_catalog.setval('image_id_seq', 5, true);
...
72	1516727958724_shops_created_at	2018-01-24 15:00:08.189968
\.
...
SELECT pg_catalog.setval('product_offering_id_seq', 9, true);
...
SELECT pg_catalog.setval('product_offering_option_id_seq', 18, true);
...
1	last_seen_shop	2	2018-01-03 17:16:37.624752+01
\.
...
SELECT pg_catalog.setval('variation_id_seq', 2, true);
...
SELECT pg_catalog.setval('variation_option_id_seq', 6, true);
